...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $settings = array(
            array('key' => 'site_title','value' => '"Quick BioLink"'),
            ...
            array('key' => 'date_format','value' => '"10"'),
            ...
            array('key' => 'smtp','value' => '{"status":"0","from_email":null,"from_name":null,"mailer":"smtp","host":null,"port":null,"username":null,"password":null,"encryption":"tls"}'),
            array('key' => 'currency','value' => '{"code":"USD","symbol":"$","position":"1"}'),
            array('key' => 'subscription','value' => '{"about_to_expire_reminder":"1","expired_reminder":"1","delete_expired":"7"}'),
