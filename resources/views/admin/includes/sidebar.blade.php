<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo ">
      ...
      <span class="app-brand-logo demo">
          <img width="25" src="{{ asset('storage/brand/'.$settings->media->admin_logo) }}" alt="{{ @$settings->site_title }}" />
            ...
            <span class="app-brand-text demo menu-text fw-bold">{{ admin_lang('Admin') }}</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">{{ admin_lang('Apps') }}</span>
        </li>
        <li class="menu-item" data-page="dashboard">
            <a href="{{ route('admin.dashboard') }}" class="menu-link">
                <i class="menu-icon icon-feather-home"></i>
                <div class="text-truncate">{{ admin_lang('Dashboard') }}</div>
            </a>
        </li>
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">{{ admin_lang('MANAGEMENT') }}</span>
        </li>
        <li class="menu-item" data-page="posts">
            <a href="{{ route('admin.posts.index') }}" class="menu-link">
                ...
                <div class="text-truncate">{{ admin_lang('Bio Links') }}</div>
            </a>
        </li>
        <li class="menu-item" data-page="users">
            <a href="{{ route('admin.users.index') }}" class="menu-link">
                <i class="menu-icon  icon-feather-users"></i>
                <div class="text-truncate">{{ admin_lang('Manage Users') }}</div>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item" data-page="coupons">
                    <a href="{{ route('admin.coupons.index') }}" class="menu-link">
                        <div class="text-truncate">{{ admin_lang('Coupon Codes') }}</div>
                    </a>
                </li>
                <li class="menu-item" data-page="taxes">
                    <a href="{{ route('admin.taxes.index') }}" class="menu-link">
                        <div class="text-truncate">{{ admin_lang('Taxes') }}</div>
                    </a>
                </li>
            </ul>
        </li>
        <li class="menu-item" data-page="gateways">
            <a href="{{ route('admin.gateways.index') }}" class="menu-link">
                ...
                <div class="text-truncate">{{ admin_lang('Payment Gateways') }}</div>
            </a>
        </li>
        <li class="menu-item" data-page="transactions">
            <a href="{{ route('admin.transactions.index') }}" class="menu-link">
                ...
                <div class="text-truncate">{{ admin_lang('Transactions') }}</div>
        ...
        <li class="menu-item" data-page="email-template">
            <a href="{{ route('admin.mailtemplates.index') }}" class="menu-link">
                ...
                <div class="text-truncate">{{ admin_lang('Email Templates') }}</div>
            </a>
        </li>
        ...
        <li class="menu-item" data-page="advertisements">
            <a href="{{ route('admin.advertisements.index') }}" class="menu-link">
                ...
                <div class="text-truncate">{{admin_lang('Advertisements')}}</div>
            </a>
        </li>
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">{{ admin_lang('Settings') }}</span>
        </li>
        <li class="menu-item" data-page="settings">
            <a href="{{ route('admin.settings.index') }}" class="menu-link">
                <i class="menu-icon  icon-feather-settings"></i>
                <div class="text-truncate">{{ admin_lang('Settings') }}</div>
            </a>
        </li>
        <li class="menu-item" data-page="seo">
            <a href="{{ route('admin.seo.index') }}" class="menu-link">
                <i class="menu-icon icon-feather-life-buoy"></i>
                <div class="text-truncate">{{admin_lang('SEO Configurations')}}</div>
            </a>
        </li>
        <li class="menu-item" data-page="templates">
            <a href="{{ route('admin.templates.index') }}" class="menu-link">
                ...
                <div class="text-truncate">{{admin_lang('Templates')}}</div>
            </a>
        </li>
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">{{ admin_lang('Account') }}</span>
        </li>
        <li class="menu-item" data-page="system-info">
            <a href="{{ route('admin.systemInfo.index') }}" class="menu-link">
                <i class="menu-icon icon-feather-book-open"></i>
                <div class="text-truncate">{{admin_lang('System Info')}}</div>
            </a>
        </li>
        <li class="menu-item" data-page="logout">
            <a href="javascript:void(0);" class="menu-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                ...
                <div class="text-truncate">{{admin_lang('Logout')}}</div>
            </a>
        ...
        <li class="menu-header hide-arrow small">
            <span class="menu-header-text">{{admin_lang('Version')}} {{env('APP_VERSION')}}</span>
        </li>
    </ul>
</aside>
