...
@section('title', lang('Languages'))
@section('header_buttons')
    <a href="#" data-url="{{ route('admin.languages.create') }}" data-toggle="slidePanel" class="btn btn-primary ms-2"><i class="icon-feather-plus me-2"></i> {{ lang('Add New') }}</a>
@endsection
@section('content')
