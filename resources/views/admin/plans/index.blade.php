...
@section('content')
    <div class="quick-card card">
        <div class="card-body">
            <div class="dataTables_wrapper">
                <table class="table table-striped" id="ajax_datatable" data-jsonfile="{{ route('admin.plans.index') }}" data-reorder-route="{{ route('admin.plans.reorder') }}" data-order-dir="asc">
                    <thead>
                    <tr>
                        <th width="20"></th>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="{{ route('admin.plans.delete') }}"
        ...
        <button type="button" class="front-icon btn btn-primary btn-floating"
                data-url="{{ route('admin.plans.create') }}" data-toggle="slidePanel">
