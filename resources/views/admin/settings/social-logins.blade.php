                ...
                <div class="accordion" id="accordions">
                    ...
                    <div class="card accordion-item mb-3">
                        ...
                        <div id="facebook" class="accordion-collapse collapse" data-bs-parent="#accordions" style="">
                            <div class="accordion-body">
                                <div class="mb-3">
                                    {{quick_switch(lang('Status'), 'facebook_login[status]', @$settings->facebook_login->status == '1')}}
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            <label class="form-label">{{ lang('Facebook Callback Url') }} </label>
                    ...
                    <div class="card accordion-item mb-3">
                        ...
                        <div id="google" class="accordion-collapse collapse" data-bs-parent="#accordions" style="">
                            <div class="accordion-body">
                                <div class="mb-3">
                                    {{quick_switch(lang('Status'), 'google_login[status]', @$settings->google_login->status == '1')}}
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            <label class="form-label">{{ lang('Google Callback Url') }} </label>
                                            <input type="text" class="form-control"
