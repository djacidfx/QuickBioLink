        ...
        <div class="quick-card card">
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-12">
                        <label class="form-label">{{ admin_lang('Subscription Expired Reminder') }} *</label>
                    ...
                    <div class="col-lg-12">
                        <label class="form-label">{{ admin_lang('Delete Expired Subscriptions') }} *</label>
            ...
            <div class="card-footer">
                ...
                <button name="submit" type="submit" class="btn btn-primary">{{ admin_lang('Save') }}</button>
            </div>
        </div>
    </form>
</div>
