...
@section('title', admin_lang('Add New Blog'))
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="tags" rows="2" class="form-control"
                                      placeholder="{{ admin_lang('Enter tags separated by comma') }}" required>{{ old('tags') }}</textarea>
                        </div>
                        <button class="btn btn-primary">{{ admin_lang('Submit') }}</button>
                    </div>
                </div>
            </div>
        </div>
