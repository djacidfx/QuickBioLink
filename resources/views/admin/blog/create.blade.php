...
@section('title', lang('Add New Blog'))
@section('content')
    <form id="quick-submitted-form" action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="short_description" rows="2" class="form-control"
                                      placeholder="{{ lang('Maximum 150 characters') }}" required>{{ old('short_description') }}</textarea>
                        </div>
                        <div class="mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="tags" rows="2" class="form-control"
                                      placeholder="{{ lang('Enter tags separated by comma') }}" required>{{ old('tags') }}</textarea>
                        </div>
