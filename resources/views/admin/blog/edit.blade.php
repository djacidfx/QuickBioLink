                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="short_description" rows="3" class="form-control"
                                      placeholder="{{ lang('Maximum 150 characters') }}" required>{{ $article->short_description }}</textarea>
                        </div>
                        <div class="mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="tags" rows="2" class="form-control"
                                      placeholder="{{ lang('Enter tags separated by comma') }}" required>{{ $article->tags }}</textarea>
                        </div>
