    ...
    <form action="{{ route('install.database') }}" method="post">
        ...
        <div class="quick-card card">
            <div class="card-header">
                <h5 class="text-center">{{ lang('Database Configuration') }}</h5>
            </div>
            <div class="card-body">
                ...
                @endif
                <div class="mb-3">
                    <label class="form-label" for="database-hostname">{{ lang('Database Hostname') }}</label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="database-port">{{ lang('Database Port') }}</label>
                ...
                <div class="mb-3 {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    <label class="form-label" for="database-name">{{ lang('Database Name') }}</label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="database-username">{{ lang('Database Username') }}</label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="database-password">{{ lang('Database User Password') }}</label>
