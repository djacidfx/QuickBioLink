...
@section('title', lang('My Subscription', 'account'))
@section('content')
    <div class="d-flex justify-content-between align-items-center pb-30">
        <div class="title-head">
            <h1 class="mb-0">{{ lang('My Subscription', 'account') }}</h1>
        </div>
    </div>
    <div class="card">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-12 col-lg-auto">
                            <a href="{{ route('pricing') }}" class="button -primary w-100">
                                ...
                                <span>{{ lang('Change Plan', 'account') }}</span>
                            </a>
                        </div>
            ...
            @else
                <div class="py-5 text-center">
                    ...
                    <a href="{{ route('pricing') }}"
                       class="button -primary">{{ lang('Subscribe Now', 'account') }}</a>
                </div>
            @endif
        </div>
    </div>
