        ...
        <ul class="sidemenu-nav h-100" id="sidemenu-nav" data-simplebar>
            <li class="nav-item  {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                <a href="{{ route('dashboard') }}" class="nav-link">
                    ...
                    <span class="menu-title">{{ lang('Dashboard', 'account') }}</span>
                </a>
            </li>
            <li class="pl-24 pt-24 font-12 mb-5 text-uppercase text-grey-1">{{ lang('Organize and Manage', 'account') }}</li>
            <li class="nav-item {{ request()->routeIs('subscription') ? 'active' : '' }}">
                <a href="{{ route('subscription') }}" class="nav-link">
                    ...
                    <span class="menu-title">{{ lang('My Subscription', 'account') }}</span>
                </a>
            </li>
            <li class="nav-item {{ request()->routeIs('transactions') ? 'active' : '' }}">
                <a href="{{ route('transactions') }}" class="nav-link">
                    ...
                    <span class="menu-title">{{ lang('Transactions', 'account') }}</span>
                </a>
            </li>
            <li class="nav-item {{ request()->routeIs('settings') ? 'active' : '' }}">
                <a href="{{ route('settings') }}" class="nav-link">
                    <span class="icon"><i class="fa-regular fa-cog"></i></span>
                    <span class="menu-title">{{ lang('Settings', 'account') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <span class="icon"><i class="fa-regular fa-sign-out"></i></span>
                    <span class="menu-title">{{ lang('Logout', 'auth') }}</span>
                </a>
            </li>
        </ul>
    </div>
