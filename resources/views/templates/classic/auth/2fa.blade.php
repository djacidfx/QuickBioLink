...
@section('title', lang('2Fa Verification'))
@section('content')
    <div class="container vh-100 py-10 login-wrapper">
        <div class="row align-items-center justify-content-center h-100">
            <div class="col-md-5">
                ...
                <h2 class="text-center font-30 mb-30">{{ lang('2Fa Verification') }}</h2>
                <div class="card">
                    <form action="{{ route('2fa.verify') }}" method="POST" class="mt-32">
                        ...
                        <button type="submit" class="button bg-primary text-white mt-32 w-100 rounded-pill -h-48">{{ lang('Continue') }}</button>
                    </form>
                </div>
            </div>
        </div>
