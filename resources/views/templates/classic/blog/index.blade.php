                ...
                <div class="col-md-10 col-xl-8 mx-auto">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <ol class="breadcrumb text-grey-2">
                            ...
                            <li class="breadcrumb-item active text-dark-1" aria-current="page">{{ lang('Blog') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row wow fadeInUp" data-wow-delay="300ms">
                <div class="col-lg-8">
                            ...
                            @foreach ($blogs as $blog)
                                <div class="col-md-6">
                                    <div class="blog-wrap border border-1 -hover-dark shadow-none">
                                        <div class="blog-img"><img class="w-100" src="{{ asset('storage/blog/articles/'.$blog->image) }}" alt="{{ $blog->title }}"></div>
                    ...
                    @else
                        <span class="text-muted">{{ lang('No blog found') }}</span>
                    @endif
                </div>
