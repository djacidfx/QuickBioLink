...
@section('content')
    <div class="bg-animation sky-bg-animation">
        <div class="min-vh-100 d-flex justify-content-center align-items-center">
            <div class="quick-bio-wrapper position-relative animated fadeIn bg-info-l">
                ...
                <div class="position-relative p-3">
                    ...
                    <div
                        ...
                        <button class="button icon-group bg-info text-dark-1 dropdown-toggle size-35" type="button"
                                data-bs-toggle="modal" data-bs-target="#share_social">
                            <i class="fa-regular fa-up-right-from-square font-14"></i>
                        </button>
                    </div>

                    <div class="bio-picture-wrapper bg-info-l">
                                ...
                                <!--LINKS-->
                                    <div
                                        ...
                                        <a href="{{ $bioLink->settings->url }}"
                                           class="item-wrapper text-dark-2 rounded-3 shadow-3 bg-info">
