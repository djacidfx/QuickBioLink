            ...
            <div class="modal-body">
                <div class="d-flex gap-3 justify-content-center align-items-center flex-wrap my-24 sm-my-20">
                    ...
                    <div class="share-items-wrapper">
                        <a class="share-items" href="https://twitter.com/share?url={{ url('/') }}&text={{ $post->title }}" target="_blank">
                        ...
                        <a class="share-items" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/') }}" target="_blank">
                            <div class="d-flex align-items-center">
                        ...
                        <a class="share-items" href="https://web.whatsapp.com/send?text={{ url('/') }}" target="_blank">
                            <div class="d-flex align-items-center">
