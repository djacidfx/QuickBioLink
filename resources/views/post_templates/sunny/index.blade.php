            ...
            <div class="quick-bio-wrapper position-relative animated fadeIn bg-warning-l">
                ...
                <div class="position-relative p-3">
                    ...
                    <div
                        ...
                        <button class="button icon-group bg-warning text-dark-1 dropdown-toggle size-35" type="button"
                                data-bs-toggle="modal" data-bs-target="#share_social">
                            <i class="fa-regular fa-up-right-from-square font-14"></i>
                        </button>
                    </div>

                    <div class="bio-picture-wrapper bg-warning-l">
                                ...
                                <!--LINKS-->
                                    <div
                                        ...
                                        <a href="{{ $bioLink->settings->url }}"
                                           class="item-wrapper text-dark-2 rounded-2 shadow-3 bg-warning">
