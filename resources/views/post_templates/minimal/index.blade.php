...
@section('content')
    <div class="bg-animation minimal-bg-animation">
        <div class="min-vh-100 d-flex justify-content-center align-items-center" id="">
            <div class="quick-bio-wrapper position-relative animated fadeIn bg-primary-l">
                ...
                <div class="position-relative p-3">
                    ...
                    <div
                        ...
                        <button class="button icon-group bg-primary-l text-dark-1 dropdown-toggle size-35" type="button"
                                data-bs-toggle="modal" data-bs-target="#share_social">
                            <i class="fa-regular fa-up-right-from-square font-14"></i>
                        </button>
                    </div>

                    <div class="bio-picture-wrapper bg-primary-l">
                                ...
                                <!--LINKS-->
                                    <div
                                        ...
                                        <a href="{{ $bioLink->settings->url }}"
                                           class="item-wrapper text-dark-2 shadow-3 -outlined">
                                    ...
                                    <div class="quick-social-icon mx-10 mb-10">
                                        @if ($bioLink->settings->title == "email")
                                            <a href="mailto:{{ $bioLink->settings->url }}"
                                               class="icon-group -outlined text-dark-2 shadow-3 rounded-3 wow fadeInDown"
